...
{$R *.dfm}
uses unit1,unit3,unit2,unit5,unit7;
...
if ball=0 then showmessage('игра окончена'+#13+'вы проиграли и можете вернуться на главную форму, что бы попробовать ответить на все вопросы повторно')
...
0: AssignFile( f ,'7.txt');
1: AssignFile( f ,'8.txt');
2: AssignFile( f ,'9.txt');
end;
reset(f);
readln(f,s);
ball:=0;
