...
if ball=0 then showmessage('игра окончена'+#1+'вы проиграли и можете вернуться на главную форму, что бы попробовать ответить на все вопросы повторно')
...
0: AssignFile( f ,'4.txt');
1: AssignFile( f ,'5.txt');
2: AssignFile( f ,'6.txt');
end;
reset(f);
readln(f,s);
ball:=0;
